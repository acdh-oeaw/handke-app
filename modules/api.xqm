...
module namespace api="http://www.digital-archiv.at/ns/handke-app/api";
declare namespace rest = "http://exquery.org/ns/restxq";
declare namespace tei = "http://www.tei-c.org/ns/1.0";
import module namespace functx = "http://www.functx.com";
import module namespace app="http://www.digital-archiv.at/ns/handke-app/templates" at "app.xql";
...
declare 
    %rest:GET
    %rest:path("/handke-app/{$collection}/{$format}")
...
declare 
    %rest:GET
    %rest:path("/handke-app/{$collection}/{$id}/{$format}")
